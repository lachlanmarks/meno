...
class QuestionsList(List):
    ...
    def render(self, page_template):
        for data in self.page_data:
            ...
            _set_attribute(new_list_elm, _get_subelm_by_class(new_list_elm, 'q-title'), 'href', '/question/' + data['question_id'])
            _set_text(new_list_elm, _get_subelm_by_class(new_list_elm, 'q-user-link'), data['user'])
            _set_attribute(new_list_elm, _get_subelm_by_class(new_list_elm, 'q-user-link'), 'href', '/user/'+ data['user_id'])
